...
export function AboutHeroVideoPlayer() {
  ...
  return (
    ...
    >
      <video
        ref={videoRef}
        src={getAssetUrl("/about/about-hero-video.mp4")}
      ...
      {/* Floating Controls Overlay (only visible when playing and controls not hovered/hidden by browser) */}
      {isPlaying && (
