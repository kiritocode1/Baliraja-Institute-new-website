    ...
    <section className="bg-stone pb-16 pt-28 text-ink sm:pb-20 sm:pt-36">
      <div className="mx-auto grid max-w-[104rem] gap-10 px-5 sm:px-8 lg:grid-cols-12 lg:items-end">
        <div className="lg:col-span-7">
          ...
          <h1 className="mt-5 max-w-full font-title text-[clamp(2.65rem,12vw,10rem)] font-normal leading-[0.92] tracking-normal sm:max-w-[11ch] sm:text-[clamp(4.3rem,10vw,10rem)] sm:leading-[0.82]">
            <RevealText
              text={title}
              immediate
              splitBy="words"
